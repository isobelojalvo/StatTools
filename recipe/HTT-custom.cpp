...
int main() {
  ...
  string aux_shapes = string(getenv("CMSSW_BASE")) + "/src/UWAnalysis/StatTools/data/sm_higgs_ltau/datacardsOptimization/";
  ...
  for (string chn : chns) {
      string file = aux_shapes + "htt_" + chn +
          "_mt-mt1_30+pt2_20.inputs-sm-13TeV-m_vis.root";
